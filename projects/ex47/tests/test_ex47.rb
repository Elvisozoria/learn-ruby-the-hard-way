...
class TestNAME < Test::Unit::TestCase
  ...
  def test_room()
    gold = Room.new("GoldRoom",
      """This room has gold you can grab in it. There's a door to the north.""")
  ...
  def test_map()
    ...
    west = Room.new("Trees", "There are trees here, you can go up.")
    down = Room.new("Dungeon", "It's dark donw here, you can go up.")
